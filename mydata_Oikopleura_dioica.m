...
data.XpA     = [0.175632  0.118343  0.129801  0.106885  0.149443  0.182179  0.146169  0.065964  0.041412  0.085606  0.080696   0.151079; % XpXimilation data from Lombard 2009, Temp =15, u=gC/ind/d --> ind 784 m (tL) estim. 504 (TL) 
                0.823870  1.114862  1.187610  1.933276  2.078772  2.078772  4.006592  4.443078  6.771011  8.880704  10.753962  12.609034]'; % conversion factor 32e-3 J/mugC             
units.XpA = {'J/ind/d', 'J/l'}; label.XpA = {'food concentration', 'assimilation rate'};  bibkey.XpA = 'Lombard2009a';
